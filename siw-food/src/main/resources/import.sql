...
/*popolamento ricette*/
INSERT INTO Ricetta(id, nome, descrizione, cuoco_id) VALUES (nextval('ricetta_seq'), 'Torta', 'Torta ai carboni passivi', (SELECT id FROM Cuoco WHERE nome = 'Cuoco1' AND cognome = 'Cognome1'), '/images/tortabruciata.jpg');
INSERT INTO Ricetta(id, nome, descrizione, cuoco_id) VALUES (nextval('ricetta_seq'), 'Pane', 'Pane ai carboni passivi', (SELECT id FROM Cuoco WHERE nome = 'Cuoco2' AND cognome = 'Cognome2'), '/images/panebruciato.jpg');
